...
/**
 * Created by xiePing on 2018/10/11 0011.
 * Description:
 */
public class FingerUtils {
    ...
    public static  void callFingerPrint(final OnCallBackListenr listener){
        FingerprintManagerCompat managerCompat = FingerprintManagerCompat.from(Utils.getApp());
        ...
        if (keyguardManager!=null&&!keyguardManager.isKeyguardSecure()) {//判断设备是否处于安全保护中
            if (listener != null)
